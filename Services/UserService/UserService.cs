...
namespace NavratanTechTask.Services.UserService
{
    public class UserService : IUserService
    {
        ...
        public string CreateToken(User user, string tokenValue, DatabaseContext _context)
        {
            ...
            {
                Log(_context, "NavratanTech.UserService.CreateToken", ex.Message, Guid.Empty, ex);
                return string.Empty;
            }
        }
        ...
        public User GetUser(UserDto user, DatabaseContext _context)
        {
            ...
            {
                Log(_context, "NavratanTech.UserService.GetUser", ex.Message, Guid.Empty, ex);
                return null;
            }
        }
        ...
        public Response RegisterUser(User user, DatabaseContext _context)
        {
            ...
            {
                Log(_context, "NavratanTech.UserService.RegisterUser", ex.Message, Guid.Empty, ex);
                response.IsError = 'Y';
        ...
        public void SetRefreshToken(User user, RefreshToken newRefreshToken, DatabaseContext _context)
        {
            ...
            {
                Log(_context, "NavratanTech.UserService.SetRefreshToken", ex.Message, Guid.Empty, ex);
            }
        }
        ...
        public bool VerifyPasswordHash(string password, byte[] passwordHash, byte[] passwordSalt, DatabaseContext _context)
        {
            ...
            {
                Log(_context, "NavratanTech.UserService.VerifyPasswordHash", ex.Message, Guid.Empty, ex);
                return false;
            }
        }
    }
