...
namespace NavratanTechTask.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<ActionResult<User>> Register(UserDto request)
        {
            ...
            {
                _userService.Log(_context, "NavratanTech.AuthController.Register", ex.Message, Guid.Empty, ex);
                response.IsError = 'Y';
        ...
        public async Task<ActionResult<ResponseToken>> Login(UserDto request)
        {
            ...
            {
                _userService.Log(_context, "NavratanTech.AuthController.Login", ex.Message, Guid.Empty, ex);
                response.IsError = 'Y';
                response.Message = ex.Message;
                return Ok(response);
            }
        ...
        public async Task<ActionResult<ResponseToken>> RefreshToken(UserDto request)
        {
            ...
            {
                _userService.Log(_context, "NavratanTech.AuthController.RefreshToken", ex.Message, Guid.Empty, ex);
                response.IsError = 'Y';
                response.Message = ex.Message;
                return Ok(response);
            }
